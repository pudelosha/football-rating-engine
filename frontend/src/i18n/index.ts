...
export const translations = {
  en: {
    ...
    bettingSlipDetails: 'Slip details',
    bettingSlipSummary: 'Slip summary',
    ...
    bettingClearAllCoupons: 'Erase all slips',
    bettingClearAllCouponsTitle: 'Erase slip history.',
    bettingClearAllCouponsCopy: 'This will permanently delete pending, locked, won, and lost slips from your account. Your slip balance and history will reset to zero.',
    bettingClearAllCouponsTarget: 'All current and stored slips',
    bettingClearAllCouponsCountLabel: 'slips will be erased',
    bettingClearAllCouponsConfirm: 'Erase all slips',
    bettingAllCouponsDeleted: 'All virtual slips erased.',
    bettingAllCouponsDeleteFailed: 'Could not erase virtual slips.',
  ...
  pl: {
    ...
    bettingSlipDetails: 'Szczegoly kuponu',
    bettingSlipSummary: 'Podsumowanie kuponu',
    ...
    bettingClearAllCoupons: 'Wyczyść wszystkie kupony',
    bettingClearAllCouponsTitle: 'Wyczyść historię kuponów.',
    bettingClearAllCouponsCopy: 'To trwale usunie oczekujące, zablokowane, wygrane i przegrane kupony z Twojego konta. Bilans i historia kuponów wrócą do zera.',
    bettingClearAllCouponsTarget: 'Wszystkie obecne i zapisane kupony',
    bettingClearAllCouponsCountLabel: 'kupony zostaną wyczyszczone',
    bettingClearAllCouponsConfirm: 'Wyczyść kupony',
    bettingAllCouponsDeleted: 'Wszystkie wirtualne kupony wyczyszczone.',
    bettingAllCouponsDeleteFailed: 'Nie udało się wyczyścić wirtualnych kuponów.',
