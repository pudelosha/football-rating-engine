...
export const translations = {
  ...
  pl: {
    ...
    menuAdmin: 'Admin',
    menuSoon: 'Wkrótce',
    teamsPanelEyebrow: 'Dru¿yny',
    teamsPanelTitle: 'Katalog dru¿yn',
    teamsPanelCopy: 'Szukaj globalnych to¿samoœci dru¿yn po krajach, ligach, sezonach i kontekstach turniejowych.',
    teamSearch: 'Szukaj dru¿yn',
    ...
    teamDetails: 'Szczegó³y',
    teamDetailsEyebrow: 'Dru¿yna',
    teamDetailsTitle: 'Profil dru¿yny',
    teamDetailsCopy: 'Przegl¹daj dru¿ynê w kontekstach turniejowych, ratingach, meczach i snapshotach kadry.',
    backToTeams: 'Wróæ do dru¿yn',
    teamOverview: 'Przegl¹d',
    teamRatingContexts: 'Konteksty ratingowe',
    teamMatchHistory: 'Nadchodz¹ce mecze',
    teamSquadSnapshot: 'Snapshot kadry',
    teamNoContexts: 'Ta dru¿yna nie jest jeszcze powi¹zana z ¿adnym zsynchronizowanym turniejem.',
    teamNoMatches: 'Nie znaleziono meczów dla tej dru¿yny.',
    teamNoSquad: 'Brak zaimportowanego snapshotu kadry.',
    teamLoadFailed: 'Nie uda³o siê pobraæ profilu dru¿yny.',
    latestSquadValue: 'Ostatnia wartoœæ kadry',
    ...
    position: 'Pozycja',
    age: 'Wiek',
    nationality: 'Narodowoœæ',
    marketValue: 'Wartoœæ',
    contractUntil: 'Kontrakt',
    averageMarketValue: 'Œrednia wartoœæ',
    stadiumName: 'Stadion',
    noTeams: 'Nie znaleziono dru¿yn.',
    teamsLoadFailed: 'Nie uda³o siê pobraæ katalogu dru¿yn.',
    userMatchesPanelEyebrow: 'Mecze',
    userMatchesPanelTitle: 'Centrum meczów',
    userMatchesPanelCopy: 'Wybierz turniej, aby przegl¹daæ zsynchronizowane terminarze, mecze live i zakoñczone wyniki.',
    userMatchDetailsEyebrow: 'Mecze turnieju',
    userMatchDetailsTitle: 'Lista meczów',
    userMatchDetailsCopy: 'Przegl¹daj mecze turnieju i filtruj listê po etapie, rundzie lub nazwie dru¿yny.',
    ...
    captured: 'Zapisano',
    matchOpenTournament: 'Poka¿ mecze',
    matchSearch: 'Szukaj meczów',
    matchSearchPlaceholder: 'Szukaj po dru¿ynie, rundzie lub statusie',
    roundFilter: 'Runda',
    allRounds: 'Wszystkie rundy',
    backToMatches: 'Wróæ do meczów',
    predictionsPanelEyebrow: 'Predykcje',
    predictionsPanelTitle: 'Centrum predykcji',
    predictionsPanelCopy: 'Wybierz turniej, aby sprawdziæ modelowe prawdopodobieñstwa 1X2 dla nadchodz¹cych i live meczów.',
    predictionsDetailsEyebrow: 'Predykcje meczów',
    predictionsDetailsTitle: 'Tablica predykcji',
    predictionsDetailsCopy: 'Porównaj szanse gospodarzy, remisu i goœci obliczone z aktualnych warstw ratingu FTSR.',
    predictionMatchEyebrow: 'Szczegó³y predykcji',
    predictionMatchTitle: 'Analiza meczu',
    predictionMatchCopy: 'G³êbszy widok ró¿nicy ratingów, pewnoœci, przewagi domu, kursów fair i alternatywnych scenariuszy modelu.',
    predictionOpenTournament: 'Poka¿ predykcje',
    predictionOpenMatch: 'Otwórz analizê',
    predictionSearch: 'Szukaj predykcji',
    predictionSearchPlaceholder: 'Szukaj',
    backToPredictions: 'Wróæ do predykcji',
    backToPredictionList: 'Wróæ do turnieju',
    predictionSummary: 'Podsumowanie predykcji',
    homeWin: 'Wygrana gospodarzy',
    draw: 'Remis',
    awayWin: 'Wygrana goœci',
    chance: 'Szansa',
    fairOdds: 'Kurs fair',
    modelEdge: 'Przewaga modelu',
    ratingGap: 'Ró¿nica ratingów',
    neutralRatingGap: 'Neutralna ró¿nica ratingów',
    scenarioHomeRating: 'Rating gospodarzy w scenariuszu',
    scenarioAwayRating: 'Rating goœci w scenariuszu',
    homeAdvantageValue: 'Wartoœæ przewagi gospodarza',
    modelConfidence: 'Pewnoœæ modelu',
    strongestSignal: 'Najsilniejszy sygna³',
    predictedOutcome: 'Typ modelu',
    matchShape: 'Kszta³t meczu',
    ...
    slightAwayLean: 'Lekka przewaga goœci',
    moderateHomeLean: 'Umiarkowana przewaga gospodarzy',
    moderateAwayLean: 'Umiarkowana przewaga goœci',
    clearHomeLean: 'Czytelna przewaga gospodarzy',
    clearAwayLean: 'Czytelna przewaga goœci',
    strongHomeLean: 'WyraŸna przewaga gospodarzy',
    strongAwayLean: 'WyraŸna przewaga goœci',
    heavyHomeFavorite: 'Mocny faworyt u siebie',
    heavyAwayFavorite: 'Mocny faworyt na wyjeŸdzie',
    drawRiskVeryHighCopy: 'Remis jest jednym z g³ównych scenariuszy meczu, a nie tylko wariantem pobocznym.',
    drawRiskHighCopy: 'Ratingi s¹ na tyle blisko, ¿e remis jest istotnym scenariuszem.',
    drawRiskModerateCopy: 'Remis jest w typowym pi³karskim obszarze ryzyka i powinien pozostaæ widoczny.',
    drawRiskLowCopy: 'Remis jest mo¿liwy, ale presja modelu wskazuje na zwyciêzcê.',
    drawRiskVeryLowCopy: 'Remis jest wyraŸnie przygaszony przez uk³ad modelu.',
    ...
    actualModelIngredients: 'Finalny rating: Base Elo, forma, performance i jakoœæ kadry',
    ...
    historicSplit: 'Historyczny podzia³ %',
    historicSplitIngredients: 'Rzeczywisty podzia³ zwyciêstw gospodarzy, remisów i goœci z historycznych meczów H2H',
    ...
    goalOutputIngredients: 'Porównuje œredni¹ liczbê strzelonych goli na mecz w historycznym oknie danych',
    ...
    goalOutputAwayEdge: 'Przewaga bramkowa goœci',
    goalOutputDrawPressure: 'Presja remisu',
    goalOutputHomeGpm: 'Gole gospodarzy/mecz',
    goalOutputAwayGpm: 'Gole goœci/mecz',
    goalOutputGap: 'Ró¿nica bramek',
    ...
    calibratedModelIngredients: 'Aktualny model wyg³adzony do realistycznych rozk³adów pi³karskich 1X2',
    calibratedModelHomeAdvantageIngredients: 'Aktualny model, wyg³adzone skrajnoœci i przewaga gospodarza',
    modelAgreement: 'Zgodnoœæ modelu',
    modelAgreementIngredients: 'Sprawdza, czy warstwy scenariuszy wskazuj¹ ten sam wynik meczu',
    modelAgreementSupported: 'wspiera',
    agreementVeryStrong: 'Bardzo mocna zgodnoœæ',
    agreementStrong: 'Mocna zgodnoœæ',
    agreementModerate: 'Umiarkowana zgodnoœæ',
    ...
    squadAdjustedIngredients: 'Base Elo plus korekta jakoœci kadry',
    squadAdjustedHomeAdvantageIngredients: 'Base Elo, korekta jakoœci kadry i przewaga gospodarza',
    dataConfidence: 'Pewnoœæ danych',
    noPrediction: 'Predykcja niedostêpna',
    noPredictionCopy: 'Obie dru¿yny musz¹ mieæ ratingi, aby model móg³ oszacowaæ ten mecz.',
    noFuturePredictions: 'Brak meczów do predykcji',
    noFuturePredictionsCopy: 'Predykcje s¹ dostêpne tylko dla nadchodz¹cych lub live meczów. Zakoñczone mecze s¹ ukryte w tym widoku.',
    bettingPanelEyebrow: 'Betting',
    bettingPanelTitle: 'Laboratorium kuponów',
    bettingPanelCopy: 'Twórz wirtualne kupony z predykcji modelu, œledŸ wynik i zobacz, jak ³atwo wielomeczowe kupony siê wyk³adaj¹.',
    bettingCreateCoupon: 'Utwórz nowy kupon',
    bettingBackToCoupons: 'Wróæ do kuponów',
    bettingPendingCoupons: 'Kupony oczekuj¹ce',
    bettingClosedCoupons: 'Kupony zamkniête',
    bettingNoPendingCoupons: 'Nie masz jeszcze oczekuj¹cych wirtualnych kuponów.',
    bettingNoClosedCoupons: 'Nie masz jeszcze zamkniêtych wirtualnych kuponów.',
    bettingCouponId: 'Kupon',
    bettingBets: 'Zak³ady',
    bettingBetCount: 'Liczba zak³adów',
    bettingSearchCoupons: 'Szukaj kuponów',
    bettingSearchCouponsPlaceholder: 'Szukaj po dru¿ynie, turnieju lub kuponie',
    ...
    bettingCreateCopy: 'Wyszukaj proponowane mecze, dodaj tylko wybrane pozycje i zapisz kupon do póŸniejszego rozliczenia.',
    bettingWindowStart: 'Od',
    bettingWindowEnd: 'Do',
    bettingLeanLevel: 'Si³a wskazania',
    bettingDrawRiskLevel: 'Mo¿liwoœæ remisu',
    bettingStake: 'Stawka',
    ...
    bettingSearchManual: 'Szukaj meczu rêcznie',
    bettingManualSearchTitle: 'Wyszukaj mecze',
    bettingManualSearchCopy: 'Szukaj po dru¿ynie, turnieju, rundzie lub dacie. Najbli¿sze pasuj¹ce mecze s¹ na górze.',
    bettingManualSearchPlaceholder: 'Szukaj dru¿yny lub turnieju',
    bettingManualSearchLimitNote: 'Wpisz frazê, aby wyœwietliæ maksymalnie 10 najbli¿szych pasuj¹cych meczów.',
    bettingAddToCoupon: 'Dodaj',
    bettingConfirmBet: 'PotwierdŸ zak³ad',
    bettingRemoveFromCoupon: 'Usuñ',
    bettingSaveCoupon: 'Utwórz kupon',
    bettingCouponCreated: 'Wirtualny kupon utworzony.',
    bettingCouponCreateFailed: 'Nie uda³o siê utworzyæ wirtualnego kuponu.',
    bettingCouponDeleted: 'Wirtualny kupon usuniêty.',
    bettingCouponDeleteFailed: 'Nie uda³o siê usun¹æ wirtualnego kuponu.',
    bettingNoSelectedMatches: 'Nie wybrano jeszcze ¿adnych meczów.',
    bettingNoCoupon: 'Nie znaleziono meczów dla tych filtrów. Spróbuj szerszego zakresu dat lub ni¿szej si³y wskazania.',
    bettingTotalOdds: '£¹czny mno¿nik',
    bettingPotentialPayout: 'Potencjalna wyp³ata',
    ...
    apiPanelCopy: 'U¿yj swojego API key, aby pobieraæ listy meczów, wyniki, mecze live i nadchodz¹ce spotkania z zewnêtrznych narzêdzi.',
    apiHeaderTitle: 'Autoryzacja',
    apiHeaderCopy: 'Przeka¿ klucz w poni¿szym nag³ówku requestu. Klucz mo¿esz zmieniæ w profilu.',
    apiAuthTokenTitle: 'Przyk³ad auth token',
    apiUserApiKeyTitle: 'API key u¿ytkownika',
    apiKeyUnavailable: 'Aktualny klucz jest przechowywany jako hash i nie mo¿na go odzyskaæ. Wygeneruj nowy klucz, aby zobaczyæ go tutaj.',
    apiReveal: 'Poka¿',
    apiHide: 'Ukryj',
    apiRequestSample: 'Przyk³adowy request',
    apiResponseSample: 'Przyk³adowa odpowiedŸ',
    apiEndpointsTitle: 'Endpointy meczowe',
    apiEndpointAll: 'Wszystkie mecze turnieju',
    apiEndpointResults: 'Zakoñczone wyniki',
    apiEndpointLive: 'Mecze live',
    apiEndpointUpcoming: 'Nadchodz¹ce mecze',
    apiEndpointSingle: 'Szczegó³y jednego meczu',
    apiKeyHeader: 'Nag³ówek',
    adminPanelEyebrow: 'Admin',
    adminPanelTitle: 'Centrum operacyjne',
    adminPanelCopy:
      'Strukturalny workspace dla sync jobów, rebuildów ratingów, importów kadr i kontroli jakoœci danych. Kontrolki s¹ na razie placeholderami gotowymi do podpiêcia pod backend.',
    adminOverview: 'Przegl¹d',
    ratingsPanelEyebrow: 'Ratingi',
    ratingsPanelTitle: 'Panel ratingów',
    ratingsPanelCopy:
      'Zarz¹dzaj konfiguracj¹ modelu i otwieraj snapshoty ratingowe turniejów dla Base Elo, formy, performance, jakoœci kadry i ³¹cznego FTSR.',
    ...
    ratingTournamentListCopy: 'Otwórz turniej, aby sprawdziæ aktualne snapshoty ratingów, runy warstw i ratingi dru¿yn.',
    userRatingsPanelEyebrow: 'Ratingi',
    userRatingsPanelTitle: 'Ratingi dru¿yn',
    userRatingsPanelCopy: 'Przegl¹daj tabele ratingów turniejów budowane z Base Elo, formy, performance i jakoœci kadry.',
    userRatingDetailsEyebrow: 'Ratingi turnieju',
    userRatingDetailsTitle: 'Tabela ratingów dru¿yn',
    userRatingDetailsCopy: 'SprawdŸ aktualne ratingi si³y dru¿yn dla wybranego turnieju.',
    ratingWeightsTitle: 'Wagi warstw',
    ratingParametersTitle: 'Domyœlne snapshotów',
    ratingSaveConfig: 'Zapisz konfiguracjê',
    ratingConfigSaved: 'Konfiguracja ratingów zapisana.',
    ratingOpenTournament: 'Poka¿ ratingi',
    ratingDetailsEyebrow: 'Ratingi turnieju',
    ratingDetailsCopy: 'Sprawdzaj ostatnie runy ratingowe i rêcznie odœwie¿aj snapshoty dla wybranego turnieju.',
    backToRatings: 'Wróæ do ratingów',
    ratingRunSnapshots: 'Snapshot runy',
    ratingModelSetup: 'Ustawienia modelu',
    ratingIncludedLayers: 'Aktywne warstwy',
    ratingIncludedLayersCopy: 'Wybierz, które warstwy wchodz¹ do wyœwietlanego ratingu koñcowego. Base Elo jest zablokowane, bo stanowi fundament modelu.',
    ...
    ratingSnapshotStartCopy: 'Steruje tym, które sezony Base Elo pobierze przy nastêpnym rebuildzie. U¿yj aktualnego sezonu, gdy historia jest niepe³na.',
    ratingTeamRatings: 'Ratingi dru¿yn',
    ...
    ratingRefreshBase: 'Odœwie¿ Base Elo',
    ratingRefreshForm: 'Odœwie¿ Formê',
    ratingRefreshPerformance: 'Odœwie¿ Performance',
    ratingRefreshing: 'Odœwie¿anie snapshotu ratingowego.',
    ratingRefreshDone: 'Snapshot ratingowy odœwie¿ony.',
    ...
    ratingConfigSquadWeight: 'Waga jakoœci kadry',
    ratingConfigLeagueWeight: 'Waga si³y ligi',
    ratingConfigUncertaintyWeight: 'Waga kary niepewnoœci',
    ...
    backToAdmin: 'Wróæ do admina',
    ratingRebuildActions: [
      { title: 'Przelicz Base Elo', copy: 'Przelicz d³ugoterminow¹ si³ê dru¿yn z zakoñczonych meczów, jakoœci przeciwnika, ró¿nicy bramek, wagi rozgrywek i zasad przewagi gospodarza.', meta: 'Mecze + historia' },
      { title: 'Przelicz Form Rating', copy: 'Odœwie¿ krótkoterminowe korekty z ostatnich wa¿onych wyników dru¿yny wzglêdem oczekiwañ Elo.', meta: 'Ostatnie 5-10 meczów' },
      { title: 'Przelicz Performance Rating', copy: 'Zaktualizuj jakoœæ gry ze statystyk meczowych takich jak xG, strza³y, posiadanie, faule, spalone i presja na bramkarza.', meta: 'Pokrycie MatchStatistics' },
      { title: 'Przelicz Squad Quality', copy: 'Przelicz si³ê kadry ze snapshotów Transfermarkt, rozk³adu wartoœci, g³êbi sk³adu, wieku i kompozycji dru¿yny.', meta: 'Snapshoty kadr' },
      { title: 'Przelicz Combined Rating', copy: 'Wygeneruj finaln¹ warstwê FTSR ³¹cz¹c¹ Base Elo, formê, performance i squad quality w jeden wyjaœnialny rating.', meta: 'FTSR v3.5' },
    ],
    ratingConfigItems: [
      'K-factor Base Elo i mno¿nik ró¿nicy bramek',
      'Przewaga gospodarza ustawiana per turniej',
      'Okno formy i wagi œwie¿oœci meczów',
      'Wagi statystyk performance i limity korekt',
      'Normalizacja wartoœci kadr i zasady g³êbi sk³adu',
      'Wagi warstw ratingu ³¹czonego',
    ],
    ratingHistoryItems: [
    ...
    squadsPanelCopy:
      'Mapuj dru¿yny turniejowe do Ÿróde³ Transfermarkt, sprawdzaj pokrycie kadr i przygotowuj dane squad quality dla modelu ratingowego.',
    squadsTableTitle: 'Pokrycie kadr w turniejach',
    squadTeamCount: 'Liczba dru¿yn',
    ...
    squadFilterUnlinked: 'Bez pe³nego mapowania',
    squadFilterMissingSnapshots: 'Bez snapshotów',
    noSquadTournaments: 'Brak turniejów dostêpnych dla administracji kadr.',
    squadLoadFailed: 'Nie uda³o siê pobraæ listy turniejów dla kadr.',
    notImported: 'Brak importu',
    squadActionComingSoon: 'Edycja kadr zostanie podpiêta w kolejnym kroku.',
    squadTeamsTitle: 'Mapowanie kadr',
    squadTeamsCopy: 'Po³¹cz ka¿d¹ dru¿ynê ze stron¹ kadry Transfermarkt i zaimportuj najnowszy snapshot squad quality dla wybranego sezonu.',
    backToSquads: 'Wróæ do kadr',
    squadSelectTournament: 'Wybierz turniej, aby edytowaæ kadry.',
    squadTeamLoadFailed: 'Nie uda³o siê pobraæ dru¿yn turnieju.',
    transfermarktUrl: 'URL Transfermarkt',
    transfermarktMapping: 'Mapowanie Transfermarkt',
    latestSnapshot: 'Ostatni snapshot',
    totalTeamValue: 'Wartoœæ dru¿yny',
    linked: 'Po³¹czono',
    notLinked: 'Brak mapowania',
    importRunning: 'Import...',
    squadImportSuccess: 'Snapshot kadry zaimportowany.',
    squadImportFailed: 'Nie uda³o siê zaimportowaæ snapshotu kadry.',
    squadBulkImportSuccess: 'Import snapshotów kadr zakoñczony.',
    squadBulkImportNoMappings: 'Nie znaleziono mapowañ Transfermarkt dla tego turnieju.',
    loading: '£adowanie',
    editSquadMappingTitle: 'Edytuj Ÿród³o kadry',
    editSquadMappingCopy: 'Wklej URL strony klubu Transfermarkt. Import znormalizuje go do szczegó³owej strony kadry dla sezonu turnieju.',
    saveAndImportSnapshot: 'Zapisz i importuj snapshot',
    squadSeason: 'Sezon snapshotu',
    adminTournamentOps: 'Turnieje',
    adminTournamentOpsCopy: 'Twórz nowe rozgrywki, przegl¹daj istniej¹ce turnieje i otwieraj dedykowany panel administracji turniejami do konfiguracji oraz utrzymania.',
    adminTeamsOps: 'Dru¿yny',
    adminTeamsOpsCopy: 'Kontroluj widocznoœæ dru¿yn, ekspozycjê w publicznym katalogu i przysz³e ustawienia to¿samoœci dru¿yn miêdzy turniejami.',
    adminTeamsPanelEyebrow: 'Dru¿yny',
    adminTeamsPanelTitle: 'Panel dru¿yn',
    adminTeamsPanelCopy: 'Zarz¹dzaj globaln¹ widocznoœci¹ dru¿yn w publicznym katalogu bez usuwania danych turniejowych, meczowych, ratingowych i predykcyjnych.',
    adminTeamsTableTitle: 'Widocznoœæ dru¿yn',
    teamFilterEnabled: 'Aktywne',
    teamFilterDisabled: 'Ukryte',
    enabled: 'Aktywna',
    disabled: 'Ukryta',
    teamVisibility: 'Widocznoœæ',
    editTeamVisibilityTitle: 'Edytuj dru¿ynê',
    editTeamVisibilityCopy: 'Zmieñ nazwê wyœwietlan¹ i zdecyduj, czy dru¿yna pojawia siê w globalnym katalogu Teams.',
    teamVisibilityCopy: 'Ukryte dru¿yny znikaj¹ z /teams, ale nadal s¹ widoczne w turniejach, meczach, ratingach i predykcjach.',
    ...
    tournamentsPanelCopy:
      'Zarz¹dzaj rozgrywkami zdefiniowanymi w aplikacji. Przeszukuj bazê turniejów, sprawdzaj pokrycie sync i otwieraj akcje edycji lub usuwania dla ka¿dego turnieju.',
    ...
    neverSynced: 'Nigdy',
    tournamentLoadFailed: 'Nie uda³o siê pobraæ turniejów.',
    tournamentDeleteSuccess: 'Turniej usuniêty.',
    tournamentDeleteConfirm: 'Usun¹æ ten turniej?',
    tournamentDeleteTitle: 'Usuñ turniej',
    tournamentDeleteCopy:
      'To usunie turniej oraz powi¹zane mecze, etapy, dru¿yny i historiê synchronizacji z bazy danych. Tej akcji nie mo¿na cofn¹æ.',
    cancel: 'Anuluj',
    confirmDelete: 'Usuñ turniej',
    tournamentCreateEyebrow: 'Nowy turniej',
    tournamentCreateTitle: 'Dodaj turniej',
    tournamentCreateCopy:
      'Wklej URL rozgrywek z LiveScore, sprawdŸ wykryte metadane, a potem utwórz turniej. Utworzenie uruchamia te¿ pierwszy pe³ny sync.',
    tournamentEditEyebrow: 'Konfiguracja turnieju',
    tournamentEditTitle: 'Edytuj turniej',
    tournamentEditCopy:
      'Zmieñ nazwê widoczn¹ w panelu, URL Ÿród³owy i ustawienia zapytañ. Zmiana URL jest dozwolona tylko wtedy, gdy nadal wskazuje te same rozgrywki LiveScore.',
    liveScoreUrl: 'URL LiveScore',
    liveScoreUrlPlaceholder: 'https://www.livescore.com/en/football/england/premier-league/',
    tournamentDisplayName: 'Nazwa wyœwietlana',
    tournamentDisplayNamePlaceholder: 'Zostaw puste, aby u¿yæ wykrytej nazwy',
    locale: 'Locale',
    timezoneOffset: 'Przesuniêcie strefy czasowej',
    previewTournament: 'Podgl¹d turnieju',
    ...
    tournamentPreviewLoaded: 'Podgl¹d turnieju pobrany.',
    tournamentNotFound: 'Nie znaleziono turnieju.',
    tournamentUrlInvalid: 'Podaj prawid³owy URL rozgrywek LiveScore',
    tournamentDetailsEyebrow: 'Szczegó³y turnieju',
    ...
    upcoming: 'Nadchodz¹ce',
    live: 'Live',
    finalized: 'Zamkniête',
    problemRecords: 'Problematyczne rekordy',
    missingTeams: 'Brakuj¹ce dru¿yny',
    nextMatch: 'Nastêpny mecz',
    ...
    finalizeSync: 'Finalize sync',
    resultsSync: 'Results sync',
    fullSyncCopy: 'Odœwie¿a fixtures i results razem ze szczegó³ami wyników.',
    scheduleSyncCopy: 'Odœwie¿a zmiany terminarza i przysz³e mecze.',
    liveSyncCopy: 'Aktualizuje mecze live oraz te, które zaraz startuj¹.',
    finalizeSyncCopy: 'Potwierdza zakoñczone mecze i uzupe³nia detale.',
    resultsSyncCopy: 'Uzgadnia zamkniête mecze z zak³adki results.',
    syncStarted: 'Sync zakoñczony.',
    ...
    matchStatusLive: 'Live',
    matchStatusFinished: 'Zakoñczony',
    matchStatusPostponed: 'Prze³o¿ony',
    ...
    loadingTournament: '£adowanie turnieju.',
    backToTournaments: 'Wróæ do turniejów',
    activeTournament: 'Turniej aktywny',
    inactiveTournament: 'Turniej nieaktywny',
    homeAdvantage: 'Przewaga gospodarza',
    homeAdvantageEnabled: 'Przewaga gospodarza dzia³a',
    ...
    activateTournamentCopy:
      'Aktywne turnieje s¹ uwzglêdniane przez hosted background synchronization. Serwisy schedule, live, finalize i results mog¹ automatycznie utrzymywaæ turniej aktualny.',
    deactivateTournamentCopy:
      'Nieaktywne turnieje s¹ wstrzymane i pomijane przez hosted background synchronization. Istniej¹ce dane zostaj¹ dostêpne, a rêczne sync actions nadal mo¿na uruchamiaæ z tego panelu.',
    confirmActivate: 'Aktywuj turniej',
    confirmDeactivate: 'Dezaktywuj turniej',
    tabDetails: 'Szczegó³y',
    tabTeams: 'Dru¿yny',
    tabMatches: 'Mecze',
    teamName: 'Dru¿yna',
    abbreviation: 'Skrót',
    ...
    score: 'Wynik',
    round: 'Runda',
    editTeamTitle: 'Edytuj dru¿ynê',
    editTeamCopy: 'Zmieñ nazwê wyœwietlan¹ dru¿yny i skrót u¿ywany w widokach turnieju.',
    teamUpdated: 'Dru¿yna zaktualizowana.',
    saveTeam: 'Zapisz dru¿ynê',
    editMatchTitle: 'Edytuj mecz',
    editMatchCopy:
      'Zmieñ szczegó³y meczu rêcznie. Live sync mo¿e nadpisaæ wynik, status i godzinê, ale rêcznie ustawiona runda oraz etap zostan¹ zachowane.',
    saveMatch: 'Zapisz mecz',
    matchUpdated: 'Mecz zaktualizowany.',
    stage: 'Etap',
    noStage: 'Bez etapu',
    finalScore: 'Wynik koñcowy',
    regularTimeScore: 'Wynik po regulaminowym czasie',
    afterExtraTimeScore: 'Wynik po dogrywce',
    penaltiesScore: 'Karne',
    rawStatus: 'Status Ÿród³owy',
    syncState: 'Stan sync',
    addTournamentComingSoon: 'Flow tworzenia turnieju zostanie podpiêty w kolejnym kroku.',
    editTournamentComingSoon: 'Flow edycji turnieju zostanie podpiêty w kolejnym kroku.',
    adminRatingOps: 'Ratingi',
    adminRatingOpsCopy: 'Zarz¹dzaj rating runami i przeliczaj Base Elo, formê, performance, jakoœæ kadry oraz ³¹czny FTSR dla wybranych turniejów.',
    adminSquadOps: 'Kadry',
    adminSquadOpsCopy: 'Zarz¹dzaj Ÿród³ami kadr, mapuj dru¿yny do Transfermarkt, importuj listy zawodników i utrzymuj snapshoty jakoœci kadr dla ratingów.',
    adminQualityOps: 'Jakoœæ danych',
    adminQualityOpsCopy: 'Sprawdzaj brakuj¹ce statystyki meczowe, stare snapshoty kadr, niezakoñczone fixtures i inne luki danych przed rebuildami ratingów.',
    adminNotificationsOps: 'Powiadomienia',
    adminNotificationsOpsCopy: 'Przygotuj wiadomoœci do u¿ytkowników, alerty us³ug, przypomnienia aktywacyjne i przysz³e komunikaty email lub w aplikacji.',
    dataQualityPanelEyebrow: 'Jakoœæ danych',
    dataQualityPanelTitle: 'Panel zdrowia danych',
    dataQualityPanelCopy:
      'Planowany workspace do przegl¹du brakuj¹cych danych turniejów, starych próbek, niepe³nych rekordów meczów, wieku snapshotów kadr i œwie¿oœci sync. Na razie to tylko UI.',
    dataQualityReadinessTitle: 'Snapshot zdrowia danych',
    dataQualityChecksTitle: 'Kontrole danych turniejów',
    dataQualityQueueTitle: 'Podgl¹d kolejki problemów',
    dataQualityRatingGateTitle: 'Regu³y œwie¿oœci',
    dataQualitySeverity: 'Priorytet',
    dataQualityArea: 'Obszar',
    dataQualitySignal: 'Sygna³',
    ...
    dataQualityAcceptVisible: 'Akceptuj widoczne ostrze¿enia',
    dataQualityAccepted: 'Ostrze¿enia zaakceptowane.',
    dataQualityAcceptCopy: 'Zaakceptowane ostrze¿enia s¹ ukryte w tym panelu, ale dane Ÿród³owe pozostaj¹ bez zmian.',
    dataQualityChecks: [
      { key: 'tournament-structure', title: 'Struktura turnieju', status: 'Identity', copy: 'Brakuj¹ca identyfikacja, dru¿yny, stage, LiveScore ID albo niespójne metadane sezonu.' },
      { key: 'match-completeness', title: 'Kompletnoœæ meczów', status: 'Mecze', copy: 'Brakuj¹ce dru¿yny, kickoffy, finalne wyniki, stare niezakoñczone mecze albo rêczny round/stage do sprawdzenia.' },
      ...
      { key: 'match-statistics', title: 'Statystyki meczowe', status: 'Stats', copy: 'Zakoñczone mecze bez MatchStatistics, xG albo u¿ytecznych wejœæ performance.' },
      { key: 'squad-snapshots', title: 'Snapshoty kadr', status: 'Kadry', copy: 'Dru¿yny bez mapowañ Transfermarkt, œwie¿ych snapshotów, wartoœci zawodników albo pe³nych metadanych kadry.' },
      { key: 'sync-freshness', title: 'Œwie¿oœæ sync', status: 'Joby', copy: 'Stare próbki sync, ostatnie b³êdy albo turnieje poza oczekiwanym oknem odœwie¿enia.' },
    ],
    adminUsersOps: 'U¿ytkownicy i dostêp',
    adminUsersOpsCopy: 'Przegl¹daj u¿ytkowników, status kont, poziom dostêpu, blokady i przysz³e ustawienia widocznoœci wed³ug ról.',
    usersPanelEyebrow: 'U¿ytkownicy i dostêp',
    usersPanelTitle: 'Kontrola dostêpu',
    usersPanelCopy:
      'Przysz³y workspace admina do przegl¹du kont, przypisywania ról, aktywacji, blokad, kluczy API i audytu dostêpu. Na razie jest to tylko UI.',
    usersDirectoryTitle: 'Katalog u¿ytkowników',
    usersAccessTitle: 'Model dostêpu',
    usersAuditTitle: 'Sygna³y audytu',
    userEmail: 'Email',
    ...
    userActions: 'Akcje',
    userSearch: 'Szukaj u¿ytkowników',
    userSearchPlaceholder: 'Szukaj po emailu, nazwie lub roli',
    userFilterAll: 'Wszyscy',
    userFilterActive: 'Aktywni',
    userFilterPending: 'Oczekuj¹cy',
    userFilterLocked: 'Zablokowani',
    userDetailsTitle: 'Szczegó³y u¿ytkownika',
    userDetailsCopy: 'SprawdŸ to¿samoœæ konta, status dostêpu, role i stan potwierdzenia emaila.',
    userSuspendTitle: 'Zawieœ u¿ytkownika',
    userSuspendCopy: 'Zawieszeni u¿ytkownicy s¹ blokowani i nie mog¹ korzystaæ z chronionych widoków aplikacji do czasu przywrócenia dostêpu.',
    userUnsuspendTitle: 'Przywróæ u¿ytkownika',
    userUnsuspendCopy: 'To przywraca dostêp wybranemu u¿ytkownikowi, jeœli jego dane logowania s¹ poprawne.',
    userDeleteTitle: 'Usuñ u¿ytkownika',
    userDeleteCopy: 'To usuwa konto u¿ytkownika z systemu. Tej akcji nie mo¿na cofn¹æ.',
    userSuspendSuccess: 'U¿ytkownik zawieszony.',
    userUnsuspendSuccess: 'U¿ytkownik przywrócony.',
    userDeleteSuccess: 'U¿ytkownik usuniêty.',
    userRoleChangeSuccess: 'Rola u¿ytkownika zaktualizowana.',
    userConfirmationResent: 'Email potwierdzaj¹cy wys³any.',
    ...
    suspend: 'Zawieœ',
    unsuspend: 'Przywróæ',
    changeRole: 'Zmieñ rolê',
    resendConfirmation: 'Wyœlij email potwierdzaj¹cy',
    adminUserActionsTitle: 'Akcje u¿ytkownika',
    adminUserActionsCopy: 'Wybierz operacjê na koncie. Destrukcyjne akcje dostêpu wymagaj¹ potwierdzenia przed wykonaniem.',
    confirmAction: 'PotwierdŸ akcjê',
    accessPrepared: 'Przygotowane',
    accessActive: 'Aktywny',
    accessPending: 'Oczekuje',
    accessLocked: 'Zablokowany',
    accessRoleItems: [
      'Administratorzy mog¹ zarz¹dzaæ turniejami, kadrami, rebuildami ratingów i przysz³ymi jobami systemowymi.',
      'Zwykli u¿ytkownicy mog¹ przegl¹daæ dashboardy, publiczne wyniki ratingów i w³asny profil.',
      'Przysz³e kontrole super admina mog¹ obs³ugiwaæ operacje destrukcyjne i zmiany ról.',
    ],
    accessAuditItems: ['Status potwierdzenia emaila', 'Reset has³a', 'Rotacja klucza API', 'Nieudane logowania', 'Blokady kont', 'Zmiany ról'],
    sampleUsers: [
      { email: 'pudel1985@gmail.com', name: 'pudel1985', role: 'Admin', status: 'Aktywny', lastSeen: 'Bie¿¹ca sesja' },
      { email: 'analyst@example.com', name: 'League Analyst', role: 'U¿ytkownik', status: 'Oczekuje', lastSeen: 'Jeszcze nieaktywny' },
      { email: 'operator@example.com', name: 'Data Operator', role: 'Admin', status: 'Zablokowany', lastSeen: 'Statyczny preview' },
    ],
    adminSystemJobsOps: 'System jobs',
    adminSystemJobsOpsCopy: 'Monitoruj zaplanowane sync serwisy, interwa³y, ostatnie uruchomienia, b³êdy i zdrowie procesów w tle.',
    systemJobsPanelEyebrow: 'System jobs',
    systemJobsPanelTitle: 'Kontrola synchronizacji w tle',
    systemJobsPanelCopy:
      'Przysz³y panel operatora dla zaplanowanej synchronizacji LiveScore, finalizacji meczów, importów kadr i kolejek rebuildów ratingów. Na razie to tylko UI.',
    systemJobsCoreTitle: 'Hosted services',
    systemJobsGlobalSyncTitle: 'Globalne operacje sync',
    systemJobsRecentTitle: 'Ostatnie sync runy',
    systemJobsHealthTitle: 'Stan us³ug',
    systemJobsPrepared: 'Przygotowany',
    systemJobsPaused: 'Wstrzymany',
    systemJobsManual: 'Rêczny',
    systemJobsLive: 'Live',
    ...
    systemJobsInterval: 'Interwa³',
    systemJobsHoldService: 'Wstrzymaj service',
    systemJobsServiceUpdated: 'Ustawienia service zaktualizowane lokalnie.',
    systemJobsGlobalSyncCopy: 'Te akcje docelowo uruchomi¹ sync dla wszystkich aktywnych turniejów, nie tylko jednego turnieju.',
    systemJobsNextRun: 'Nastêpne uruchomienie',
    systemJobsLastRun: 'Ostatnie uruchomienie',
    systemJobsLastSuccess: 'Ostatni sukces',
    systemJobsLastFailure: 'Ostatni b³¹d',
    systemJobsEligibleTournaments: 'Kwalifikuj¹ce siê turnieje',
    systemJobsRuns24h: 'Runy 24h',
    systemJobsFailures24h: 'B³êdy 24h',
    systemJobsCoreItems: [
      { serviceKey: 'schedule-sync', title: 'Schedule sync service', cadence: 'Co 60 minut', status: 'Live', nextRun: '08:00', copy: 'Odœwie¿a daty fixtures, prze³o¿one mecze, nieznane dru¿yny, metadane turnieju i strukturê przysz³ych spotkañ.' },
      { serviceKey: 'live-results', title: 'Live results service', cadence: 'Co 1 minutê', status: 'Live', nextRun: 'Gdy kickoff jest due', copy: 'Sprawdza fixtures rozgrywek w okolicach zaplanowanego kickoffu i aktualizuje live score bez indywidualnych zapytañ meczu.' },
      { serviceKey: 'match-finalizer', title: 'Match finalizer service', cadence: 'Co 1 minutê', status: 'Live', nextRun: 'Po oknie live', copy: 'Wykrywa mecze przeniesione z fixtures do results, potwierdza finalny status i zamyka rekordy.' },
      { title: 'Match details extractor', cadence: 'U¿ywa interwa³u finalizera', status: 'Live', nextRun: 'Tylko AET/AP', copy: 'Pobiera incydenty pojedynczego meczu tylko gdy potrzebna jest dogrywka, karne lub bogatsze detale finalne.' },
      { serviceKey: 'results-safety-net', title: 'Results safety net service', cadence: 'Co 1440 minut', status: 'Live', nextRun: '03:30', copy: 'Ponownie czyta zakoñczone mecze jako wolniejszy reconciliation pass dla pominiêtych statusów, korekt lub przerw serwisu.' },
      { serviceKey: 'slip-validator', title: 'Betting slip validator', cadence: 'Co 1 minutê', status: 'Live', nextRun: 'Po kickoffie/wynikach', copy: 'Blokuje wirtualne kupony po pierwszym kickoffie i rozlicza je jako trafione lub przegrane, gdy wszystkie wybrane mecze s¹ finalne.' },
      { serviceKey: 'prediction-snapshot', title: 'Prediction snapshot service', cadence: 'Co 1 minutê', status: 'Live', nextRun: 'Po zakoñczonym meczu', copy: 'Zapisuje snapshoty predykcji zakoñczonych meczów, aby historia pokazywa³a typ modelu z momentu finalizacji.' },
    ],
    systemJobHealthItems: [
      { label: 'Scheduler', value: 'Gotowy', note: 'Placeholder rejestracji hosted timerów' },
      { label: 'LiveScore API', value: 'Nie sprawdzono', note: 'Przysz³y monitor opóŸnieñ i b³êdów' },
      { label: 'Email worker', value: 'Gotowy', note: 'Wiadomoœci auth s¹ ju¿ podpiête w backendzie' },
      { label: 'Rating worker', value: 'Rêczny', note: 'Przygotowany pod kolejkê rebuildów' },
    ],
    systemJobRecentRuns: [
      { job: 'Schedule sync service', mode: 'schedule', tournament: 'Wszystkie aktywne turnieje', time: 'Dziœ 06:00', result: '104 bez zmian', status: 'Sukces' },
      { job: 'Match finalizer service', mode: 'finalize', tournament: 'Wszystkie aktywne turnieje', time: 'Dziœ 05:58', result: '7 sfinalizowanych', status: 'Sukces' },
    ...
    adminPlaceholder: 'Jeszcze nie podpiête',
    backHome: 'Wroæ na stronê g³ówn¹',
    heroEyebrow: 'Platforma analityki pi³karskiej',
    heroTitle: 'Rating dru¿yn, który t³umaczy siê przed pierwszym gwizdkiem',
    heroCopy:
      'Nowoczesna aplikacja analityczna oparta o FTSR: bazowe Elo, synchronizacjê wyników, formê, statystyki gry, jakoœæ kadry i narzêdzia administracyjne.',
    explore: 'Zobacz platformê',
    signIn: 'Zaloguj',
    combinedRating: 'Rating ³¹czny',
    dataFeeds: 'ród³a danych',
    adminJobs: 'Zadania admina',
    modelEyebrow: 'Model ratingowy',
    modelTitle: 'Od surowych meczów do czytelnej oceny si³y dru¿yny',
    modelCopy:
      'Ka¿dy modu³ dzia³a niezale¿nie, wiêc rating koñcowy mo¿na wyjaœniaæ, stroiæ, przeliczaæ i testowaæ bez czarnej skrzynki.',
    workspaceEyebrow: 'Widok zalogowanego u¿ytkownika',
    workspaceTitle: 'Miejsce pracy dla ratingów, meczów, kadr i predykcji',
    workspaceCopy:
      'U¿ytkownik dostaje tabele ratingowe, trendy, profile dru¿yn, kontekst meczowy i sygna³y pewnoœci. Aplikacja ma byæ szybka, konkretna i przydatna w tygodniu meczowym.',
    dataCoverage: 'Pokrycie danych',
    pipelineEyebrow: 'Przep³yw danych',
    pipelineTitle: 'Gotowe na nocne synchronizacje i odœwie¿anie w dniu meczu',
    adminEyebrow: 'Panel administratora',
    adminTitle: 'Centrum kontroli danych zasilaj¹cych ratingi',
    ctaEyebrow: 'Kolejny etap',
    ctaTitle: 'Gotowe pod routing, integracje i rozbudowê widoków',
    ctaCopy:
      'Publiczna czêœæ jest na miejscu. Widok zalogowanego u¿ytkownika mo¿e teraz rosn¹æ w dashboardy, narzêdzia admina i wyjaœnienia ratingów.',
    footerCopy:
      'Wyjaœnialne ratingi dru¿yn pi³karskich oparte o wyniki, statystyki, jakoœæ kadry i przejrzyste komponenty modelu.',
    language: 'Jêzyk',
    legal: 'Zbudowane do badañ nad analityk¹ pi³karsk¹.',
    loginTitle: 'Witaj ponownie',
    loginCopy: 'Zaloguj siê, aby przejœæ do ratingów, danych meczowych i narzêdzi admina.',
    registerTitle: 'Utwórz konto',
    registerCopy: 'Do³¹cz do workspace i zacznij eksplorowaæ modele si³y dru¿yn.',
    forgotPassword: 'Nie pamiêtasz has³a?',
    resendActivation: 'Nie dotar³ email aktywacyjny?',
    forgotPasswordEyebrow: 'Odzyskiwanie has³a',
    forgotPasswordTitle: 'Zresetuj has³o',
    forgotPasswordCopy: 'Podaj email, a poprosimy backend o link resetowania has³a.',
    resendActivationEyebrow: 'Aktywacja konta',
    resendActivationTitle: 'Wyœlij aktywacjê ponownie',
    resendActivationCopy: 'Podaj email, a wyœlemy kolejn¹ wiadomoœæ aktywacyjn¹.',
    confirmEmailEyebrow: 'Potwierdzenie emaila',
    confirmEmailLoadingTitle: 'Potwierdzamy konto',
    confirmEmailLoadingCopy: 'Poczekaj chwilê, sprawdzamy link aktywacyjny.',
    confirmEmailSuccessTitle: 'Konto potwierdzone',
    confirmEmailSuccessCopy: 'Adres email zosta³ potwierdzony. Mo¿esz siê zalogowaæ.',
    confirmEmailFailureTitle: 'Potwierdzenie nieudane',
    confirmEmailFailureCopy: 'Link aktywacyjny jest niepe³ny, wygas³ albo jest nieprawid³owy. Mo¿esz poprosiæ o nowy email aktywacyjny.',    resetPasswordEyebrow: 'Reset has³a',
    resetPasswordTitle: 'Ustaw nowe has³o',
    resetPasswordCopy: 'Wybierz nowe has³o do konta i potwierdŸ zmianê.',
    resetPasswordInvalidLink: 'Link resetowania has³a nie zawiera wymaganych danych.',
    newPassword: 'Nowe has³o',
    confirmNewPassword: 'Powtórz nowe has³o',
    setNewPassword: 'Ustaw nowe has³o',
    passwordResetSuccess: 'Has³o zosta³o zresetowane. Mo¿esz siê zalogowaæ.',    sendResetLink: 'Wyœlij link resetuj¹cy',
    resendEmail: 'Wyœlij ponownie',
    backToLogin: 'Wróæ do logowania',
    goToResendActivation: 'PrzejdŸ do ponownej aktywacji',
    resetRequested: 'Wys³ano proœbê o reset has³a',
    activationRequested: 'Wys³ano proœbê o email aktywacyjny',
    email: 'Email',
    displayName: 'Nazwa wyœwietlana',
    password: 'Has³o',
    confirmPassword: 'Powtórz has³o',
    acceptTermsPrefix: 'Akceptujê',
    termsAndConditions: 'regulamin i warunki',
    termsTitle: 'Regulamin i warunki',
    termsCopy: 'Strona regulaminu jest gotowa jako placeholder routingu. Pe³n¹ treœæ mo¿na dodaæ póŸniej.',
    submitLogin: 'Zaloguj',
    submitRegister: 'Zarejestruj',
    noAccount: 'Nie masz jeszcze konta?',
    hasAccount: 'Masz ju¿ konto?',
    createAccount: 'Utwórz konto',
    useExisting: 'U¿yj istniej¹cego konta',
    required: 'To pole jest wymagane',
    termsRequired: 'Zgoda jest wymagana',
    emailInvalid: 'Podaj poprawny adres email',
    passwordShort: 'Has³o musi mieæ co najmniej 6 znaków',
    passwordMismatch: 'Has³a nie s¹ takie same',
    validationFailed: 'Popraw zaznaczone pola',
    loginSuccess: 'Logowanie zakoñczone sukcesem.',
    registerSuccess: 'Rejestracja zakoñczona. SprawdŸ email, aby aktywowaæ konto.',
    logoutSuccess: 'Wylogowano.',
    genericError: 'Coœ posz³o nie tak. Spróbuj ponownie.',
    dashboardTitle: 'Jesteœ zalogowany',
    dashboardCopy:
      'Zarz¹dzaj kontem i sprawdŸ, ¿e autoryzowane zapytania do backendu dzia³aj¹.',
    dashboardEyebrow: 'Centrum dowodzenia',
    dashboardHomeTitle: 'Dobrze Ciê widzieæ',
    dashboardHomeCopy:
      'Workspace ratingowy jest gotowy. Docelowe widgety z live data trafi¹ tutaj póŸniej; na razie dashboard pokazuje g³ówne obszary aplikacji.',
    dashboardProfileAction: 'Otwórz profil',
    dashboardCards: [
      ['Rating ³¹czny', 'FTSR', 'Base Elo, forma, performance i jakoœæ kadry jako osobne, wyjaœnialne warstwy.'],
      ['Live Sync', 'Gotowe', 'Schedule, live, finalize i results mog¹ zasilaæ bazê meczów za tym workspace.'],
      ['Admin Flow', 'Next', 'Sync turniejów, mapowanie Transfermarkt, rebuild ratingów i kontrola danych trafi¹ do panelu operatora.'],
    ],
    dashboardSignalsTitle: 'Szybki podgl¹d',
    dashboardSignals: ['Model Premier League: aktywny', 'Ostatni rating run: oczekuje na live data', 'Snapshoty kadr: mapowane rêcznie przez admina'],
    authHint: 'Token autoryzacji zapisany lokalnie dla zapytañ API.',
    profileEyebrow: 'Konto',
    profileTitle: 'Ustawienia konta',
    profileCopy: 'Profil, has³o, email i akcje API key dzia³aj¹ bezpoœrednio z backendem.',
    memberSince: 'Data do³¹czenia',
    saveProfile: 'Zapisz profil',
    profileSaved: 'Profil zaktualizowany',
    changePasswordTitle: 'Zmieñ has³o',
    currentPassword: 'Aktualne has³o',
    changePassword: 'Zmieñ has³o',
    passwordChanged: 'Has³o zmienione',
    changeEmailTitle: 'Zmieñ email',
    newEmail: 'Nowy email',
    changeEmail: 'Zmieñ email',
    emailChanged: 'Email zmieniony',
    rotateApiKeyTitle: 'API key',
    apiKeyPurposeTitle: 'Dostêp do zewnêtrznego API',
    apiKeyPurposeCopy: 'U¿yj tego klucza do odpytywania API meczów i ratingów z zewnêtrznych narzêdzi. Przeka¿ go w nag³ówku x-api-key.',
    currentApiKey: 'Aktualny API key',
    apiKeyIssued: 'Wydany',
    apiKeyHidden: 'Przechowywany bezpiecznie. Istniej¹cego klucza nie mo¿na ujawniæ po utworzeniu.',
    revealApiKey: 'Poka¿ klucz',
    hideApiKey: 'Ukryj klucz',
    rotateApiKeyConfirmTitle: 'Wygenerowaæ nowy API key?',
    rotateApiKeyConfirmCopy: 'To uniewa¿ni aktualny API key. Zewnêtrzne narzêdzia u¿ywaj¹ce starego klucza przestan¹ dzia³aæ, dopóki ich nie zaktualizujesz.',
    rotateApiKeyConfirmAction: 'Wygeneruj klucz',
    rotateApiKey: 'Wygeneruj nowy API key',
    newApiKey: 'Nowy API key',
    apiKeyRotated: 'API key zosta³ zmieniony. Zapisz go teraz; nie bêdzie ponownie pokazany.',
    profileLoadFailed: 'Nie uda³o siê pobraæ profilu.',
    sessionExpired: 'Sesja wygas³a. Zaloguj siê ponownie.',
  },
} as const
...
export function getModules(language: Language) {
  const copy = {
    ...
    pl: [
      ['FTSR v1', 'Bazowe Elo', '70%', 'D³ugoterminowa si³a dru¿yny z wyników, jakoœci rywala, miejsca meczu, ró¿nicy bramek i wagi rozgrywek.'],
      ['FTSR v1.5', 'Forma', '5-10', 'Aktualny trend oddzielony od bazowej si³y, wa¿ony œwie¿oœci¹ ostatnich meczów.'],
      ['FTSR v2', 'Performance', 'xG+', 'Jakoœæ gry z xG, strza³ów, posiadania, fauli, obron, spalonych i sygna³ów presji.'],
      ['FTSR v3', 'Jakoœæ Kadry', 'TM', 'Snapshoty Transfermarkt, wartoœæ top XI, g³êbia top 15, wiek, pozycje i pokrycie wycen zawodników.'],
    ],
  }[language]
  ...
  return {
    pipeline:
      language === 'en'
        ...
        : ['Sync LiveScore', 'Baza meczów', 'Import statystyk', 'Snapshoty kadr', 'Przeliczenia ratingów', 'Rating ³¹czny'],
    workspace:
      language === 'en'
        ...
        : ['Centrum turnieju', 'Profile ratingowe dru¿yn', 'Timeline i zdarzenia meczu', 'Monitoring terminarza', 'Diagnostyka performance', 'Laboratorium predykcji'],
    admin:
      language === 'en'
        ? [
        ...
        : [
            ...
            'Przeliczenia Base Elo, formy, performance i ratingu ³¹cznego',
            'Kontrola brakuj¹cych statystyk i nieaktualnych meczów',
          ],
  }
}
