...
export type MenuIconName = 'home' | 'dashboard' | 'ratings' | 'teams' | 'matches' | 'api' | 'tournaments' | 'predictions' | 'betting' | 'slips' | 'admin' | 'profile' | 'logout' | 'arrow-left' | 'search' | 'trash' | 'edit' | 'plus'
export type View =
  | 'landing'
  | 'login'
  | 'register'
